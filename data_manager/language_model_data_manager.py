...
class LanguageModelDataManager(BaseDataManager):
    ...
    def __init__(self, args, model_args, preprocessor, process_id=0, num_workers=1):
        ...
        super(LanguageModelDataManager, self).__init__(args, model_args, process_id, num_workers)
...
class StackOverFlowDataManager(LanguageModelDataManager):
    ...
    def __init__(self, args, model_args, preprocessor, process_id=0, num_workers=1):
        super(StackOverFlowDataManager, self).__init__(args, model_args, preprocessor, process_id, num_workers)
