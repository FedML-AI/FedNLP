...
from model.fed_transformers.experimental.classification.classification_utils import (
    InputExample,
    convert_examples_to_features,
)
from model.fed_transformers.experimental.classification.transformer_models.albert_model import (
    AlbertForSequenceClassification,
)
from model.fed_transformers.experimental.classification.transformer_models.bert_model import BertForSequenceClassification
from model.fed_transformers.experimental.classification.transformer_models.camembert_model import (
    CamembertForSequenceClassification,
)
from model.fed_transformers.experimental.classification.transformer_models.distilbert_model import (
    DistilBertForSequenceClassification,
)
from model.fed_transformers.experimental.classification.transformer_models.roberta_model import (
    RobertaForSequenceClassification,
)
from model.fed_transformers.experimental.classification.transformer_models.xlm_model import XLMForSequenceClassification
from model.fed_transformers.experimental.classification.transformer_models.xlnet_model import (
...
class ClassificationModel:
    ...
    def train_model(
        self, train_df, multi_label=False, output_dir=None, show_running_loss=True, args=None, eval_df=None
    ):
        """
    ...
    def compute_metrics(self, preds, labels, eval_examples, multi_label=False, **kwargs):
        ...
        if self.model.num_labels == 2:
            ...
            return {**{"mcc": mcc, "tp": tp, "tn": tn, "fp": fp, "fn": fn}, **extra_metrics}, wrong
