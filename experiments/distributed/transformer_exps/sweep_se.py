...
hps = [
    'FedAvg "niid_cluster_clients=10_alpha=1.0" 5e-5 0.1 30',
    'FedProx "niid_cluster_clients=10_alpha=1.0" 5e-5 0.1 30',
    'FedOPT "niid_cluster_clients=10_alpha=1.0" 5e-5 0.1 30',
]
