...
hps = [
    'FedAvg "niid_cluster_clients=10_alpha=5.0" 5e-5 0.1 30',
    'FedProx "niid_cluster_clients=10_alpha=5.0" 5e-5 0.1 30',
    # 'FedOPT "niid_cluster_clients=10_alpha=5.0" 5e-5 0.1 30', # finished by Chaoyang He
]
