...
hps = [
    'FedOPT "niid_cluster_clients=10_alpha=0.5" 5e-5 0.1 30',
    'FedProx "niid_cluster_clients=10_alpha=0.5" 5e-5 0.1 30',
    'FedAvg "niid_cluster_clients=10_alpha=0.5" 5e-5 0.1 30',
]
