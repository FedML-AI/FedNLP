...
hps = [
    # 'FedAvg "niid_cluster_clients=10_alpha=1.0" 5e-5 0.1 15', 
    # 'FedProx "niid_cluster_clients=10_alpha=1.0" 5e-5 0.1 15',
    # 'FedOPT "niid_cluster_clients=10_alpha=1.0" 5e-5 0.1 15', 
    'FedAvg "niid_cluster_clients=30_alpha=0.1" 5e-5 0.1 15', 
    # 'FedProx "niid_cluster_clients=30_alpha=0.1" 5e-5 0.1 15',
    # 'FedOPT "niid_cluster_clients=30_alpha=0.1" 5e-5 0.1 15', 
]
