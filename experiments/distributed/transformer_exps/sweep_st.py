...
hps = [
    'FedAvg "lite_niid_cluster_clients=100_alpha=1.0" 5e-5 0.1 30',
    'FedProx "lite_niid_cluster_clients=100_alpha=1.0" 5e-5 0.1 30',
    'FedOPT "lite_niid_cluster_clients=100_alpha=1.0" 5e-5 0.1 30',
    'FedProx "niid_cluster_clients=100_alpha=1.0" 5e-5 0.1 20',
    'FedAvg "niid_cluster_clients=100_alpha=1.0" 5e-5 0.1 20',
    'FedOPT "niid_cluster_clients=100_alpha=1.0" 5e-5 0.1 20',
]
